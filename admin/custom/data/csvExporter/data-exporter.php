...
tb_app_sales.date_of_sale>="'.$from_date.'" AND tb_app_sales.date_of_sale<="'.$to_date.'" AND tb_employees.client_id="$client_id" ORDER BY tb_app_sales.date_of_sale DESC';
